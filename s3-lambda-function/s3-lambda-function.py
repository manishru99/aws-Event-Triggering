# This Lambda function is triggered by an S3 event when a file is uploaded to a specific S3 bucket.
# It performs operations such as sending a notification via SNS or triggering another Lambda function.
...
def lambda_handler(event, context):
    ...
    # <account-id> to be replaced with my AWS acc ID
